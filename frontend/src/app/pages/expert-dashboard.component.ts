              ...
              @for (engagement of engagements; track engagement.id) {
                <article class="engagement-card">
                  ...
                  <div class="engagement-actions">
                    ...
                    <a class="work-log-link" [routerLink]="['/expert/work-logs', engagement.id]">{{ engagement.status === 'ACTIVE' ? 'Log / View work →' : 'View work logs →' }}</a>
