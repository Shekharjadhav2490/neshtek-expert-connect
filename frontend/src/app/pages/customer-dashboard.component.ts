            ...
            <div class="engagement-list">
              @for (engagement of engagements; track engagement.id) {
                <article class="engagement-card">
                  ...
                  <div class="engagement-status-wrap"><span class="engagement-status" [class.ready]="engagement.status === 'READY'" [class.active]="engagement.status === 'ACTIVE'" [class.completed]="engagement.status === 'COMPLETED'" [class.cancelled]="engagement.status === 'CANCELLED'">{{ engagement.status }}</span></div>
                </article>
              }
            </div>
          }
