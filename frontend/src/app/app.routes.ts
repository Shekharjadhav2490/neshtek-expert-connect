...
export const routes: Routes = [
  ...
  { path: 'customer/work-logs/:engagementId', canActivate: [authGuard, roleGuard(['CUSTOMER', 'ROLE_CUSTOMER'])], loadComponent: () => import('./pages/work-logs.component').then((m) => m.WorkLogsComponent) },
  ...
  { path: 'expert/work-logs/:engagementId', canActivate: [authGuard, roleGuard(['EXPERT', 'ROLE_EXPERT'])], loadComponent: () => import('./pages/work-logs.component').then((m) => m.WorkLogsComponent) },
