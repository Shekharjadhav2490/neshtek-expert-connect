...
export const routes: Routes = [
  ...
  { path: 'customer/financial-ledger', canActivate: [authGuard, roleGuard(['CUSTOMER', 'ROLE_CUSTOMER'])], loadComponent: () => import('./pages/financial-ledger.component').then((m) => m.FinancialLedgerComponent) },
  ...
  { path: 'expert/financial-ledger', canActivate: [authGuard, roleGuard(['EXPERT', 'ROLE_EXPERT'])], loadComponent: () => import('./pages/financial-ledger.component').then((m) => m.FinancialLedgerComponent) },
  ...
  { path: 'admin/financial-ledger', canActivate: [authGuard, roleGuard(['ADMIN', 'ROLE_ADMIN'])], loadComponent: () => import('./pages/financial-ledger.component').then((m) => m.FinancialLedgerComponent) },
