...
public class CustomerRequirement {
    ...
    @OrderBy("priorityOrder ASC") private List<CustomerRequirementSkill> skills = new ArrayList<>();
    ...
    public BigDecimal getRequiredExperienceYears(){return requiredExperienceYears;} public void setRequiredExperienceYears(BigDecimal v){requiredExperienceYears=v;}
    public BigDecimal getEstimatedHours(){return estimatedHours;} public void setEstimatedHours(BigDecimal v){estimatedHours=v;} public LocalDate getPreferredStartDate(){return preferredStartDate;} public void setPreferredStartDate(LocalDate v){preferredStartDate=v;}
    public RequirementPriority getPriority(){return priority;} public void setPriority(RequirementPriority v){priority=v;} public BigDecimal getBudget(){return budget;} public void setBudget(BigDecimal v){budget=v;}
    public String getCurrencyCode(){return currencyCode;} public void setCurrencyCode(String v){currencyCode=v;} public CustomerRequirementStatus getStatus(){return status;} public void setStatus(CustomerRequirementStatus v){status=v;}
    public LocalDateTime getCreatedAt(){return createdAt;} public LocalDateTime getUpdatedAt(){return updatedAt;} public List<CustomerRequirementSkill> getSkills(){return skills;}
}
