...
public class InvoiceService {
 private final InvoiceRepository invoices; private final EngagementRepository engagements; private final BillingSummaryService billing; private final ResourceAuthorizationService authorization; private final InvoicePdfService pdfService;
 public InvoiceService(InvoiceRepository invoices,EngagementRepository engagements,BillingSummaryService billing,ResourceAuthorizationService authorization,InvoicePdfService pdfService){this.invoices=invoices;this.engagements=engagements;this.billing=billing;this.authorization=authorization;this.pdfService=pdfService;}
