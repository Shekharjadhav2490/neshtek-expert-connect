...
public class PaymentTransactionService {
 private final PaymentTransactionRepository payments; private final InvoiceRepository invoices; private final ResourceAuthorizationService authorization;
 public PaymentTransactionService(PaymentTransactionRepository payments,InvoiceRepository invoices,ResourceAuthorizationService authorization){this.payments=payments;this.invoices=invoices;this.authorization=authorization;}
