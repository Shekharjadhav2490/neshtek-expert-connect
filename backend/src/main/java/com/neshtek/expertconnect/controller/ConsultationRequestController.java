...
public class ConsultationRequestController {
    ...
    public ConsultationRequestResponse create(@Valid @RequestBody ConsultationRequestRequest request) {
    ...
    public Page<ConsultationRequestResponse> byCustomer(@PathVariable Long customerId, Pageable pageable) {
        return service.byCustomer(customerId, pageable);
    }

    @GetMapping("/experts/{expertId}")
    public Page<ConsultationRequestResponse> byExpert(@PathVariable Long expertId, Pageable pageable) {
    ...
    public ConsultationRequestResponse reject(@PathVariable Long id) { return service.reject(id); }
}
